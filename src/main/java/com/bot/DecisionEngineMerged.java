...
public final class DecisionEngineMerged {
    ...
    private static final long COOLDOWN_MS = 6 * 60_000;
    ...
    private TradeIdea generate(String symbol,
        ...
        return new TradeIdea(symbol, side, price, stop, take, confidence, grade,
                "Score="+raw+" State="+state);
    }

    /* ================= CONFIDENCE ================= */
    private double computeConfidence(double raw, MarketState state, CoinCategory cat, double atr, double price){
        double base = raw/6.0;
        ...
        return clamp(0.52 + base + stateBoost + volatilityFactor + catBoost, 0.52,0.95);
    }
