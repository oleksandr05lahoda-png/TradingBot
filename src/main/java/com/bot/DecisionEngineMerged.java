...
public final class DecisionEngineMerged {
    ...
    private TradeIdea generate(String symbol,
        ...
        // Priority 3: Advanced Confluence (Phase 4.0) — smart-money indicators
        ...
        // Priority 4: Breakout for trending markets (only if MR/Confluence found nothing)
        ...
        // Priority 5: PumpHunter exhaustion (reversal at pump top / dump bottom)
