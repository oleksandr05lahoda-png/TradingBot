...
SHORT_ARMED=off            # 22.09: медвежья рука. OFF = бот работает как раньше, шортов нет.
                           # ON = шортит пробой 5-дневного минимума, пока BTC ниже 50-дневной
                           # средней. Выходы: стоп 2 ATR и тейк ставит бот, 48ч даёт
                           # MAX_HOLD_HOURS (обязательно, у шорта нет сигнального выхода).
                           # Слоты общие с лонгами, лонг всегда в приоритете на одну монету.
SHORT_LOW_DAYS=5           # какой минимум пробивать (по ЗАВЕРШЁННЫМ дням)
